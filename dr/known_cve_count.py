...
"""Stub: Known CVE Count — Dependency Risk (SCA) (not the target metric for this branch)."""
TOOL_HINT = 'pip-audit'
DOMAIN = 'Dependency Risk (SCA)'

class KnownCveCountAnalyzer(object):
...
def evaluate_known_cve_count_sample(inputs):
    """Lightweight domain helper for Known CVE Count."""
    analyzer = KnownCveCountAnalyzer('known_cve_count')
